...
const LandingPage = () => {   
  ...
  return (       
    <div className="flex flex-col">        
      ...
      {/* Navigation Bar */}
      <div className="fixed z-10 top-0 left-0 flex flex-row items-center justify-between w-full h-14 p-3 border-b-1 border-[var(--modal-border)] bg-[var(--background)]">
        <HeaderLogo /> 
      ...
      <div className="grid lg:grid-cols-2 items-center min-h-screen gap-x-10 gap-y-15 p-15 pt-25 ">    
        ...
        {/* Features List */}
        <div>
          <p className="p-1 mb-1 text-sm text-[var(--muted-foreground)]">FEATURES . . .</p>
